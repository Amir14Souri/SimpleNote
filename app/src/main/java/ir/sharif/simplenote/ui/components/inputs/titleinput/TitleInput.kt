package ir.sharif.simplenote.ui.components.controls.freetextareainput
        ...
        decorationBox = { innerTextField ->
            Box(modifier = Modifier.fillMaxWidth()) {
                if (value.isEmpty() && placeholder != null) {
                    Text(
                        text = placeholder,
                        style = TextStyles.text2XlBold.copy(
 ...
 */
@Preview(showBackground = true, name = "TitleInputPreview")
@Composable
