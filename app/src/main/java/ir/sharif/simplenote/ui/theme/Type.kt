...
// Custom Text Styles with all font weights
object TextStyles {
    ...
    val textBase = TextStyle(
        ...
        fontWeight = FontWeight.Normal, // 400
        fontSize = 16.sp,
        lineHeight = 22.4.sp, // 140% of 16sp
        letterSpacing = 0.sp,
    )
    ...
    val textXl = TextStyle(
        ...
        fontWeight = FontWeight.Normal, // 400
        fontSize = 24.sp,
        lineHeight = 28.8.sp, // 120% of 24sp
        letterSpacing = 0.sp,
    )
...
// Material Design 3 Typography using your custom styles
val Typography = Typography(
    ...
    titleLarge = TextStyles.textLgMedium, // Using medium weight for titles
    ...
    labelLarge = TextStyles.textSmMedium, // Using medium weight for labels
